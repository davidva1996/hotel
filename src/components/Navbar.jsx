...
const Navbar = () => {
  ...
  return (
    <div>
      ...
      <h1 className='text-white font-bold text-2xl z-20'>Viajes & Viajes</h1>
      ...
      >
        <ul className='flex flex-col fixed w-full h-full items-center justify-center'>
          ...
          <li className='font-bold text-3xl p-8'>Reservas</li>
          <li className='font-bold text-3xl p-8'>Comodidades</li>
